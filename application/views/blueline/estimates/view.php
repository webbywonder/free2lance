 		...
 		<div class="box-shadow">
 			...
 			<div class="subcont">
 				<ul class="details col-xs-12 col-sm-6">
 					...
 					<li><span><?= $this->lang->line('application_due_date2'); ?>:</span> <?php $unix = human_to_unix($estimate->due_date . ' 00:00');
																							echo date($core_settings->date_format, $unix); ?></li>
 					...
 					<li><span><?= $this->lang->line('application_category'); ?>:</span> <?php echo $estimate->category; ?></li>
