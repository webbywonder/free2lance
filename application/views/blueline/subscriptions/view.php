<div class="row">
		...
		<ul class="details col-xs-12 col-sm-6">
			...
			<?php if($subscription->subscribed != "0" && $subscription->subscribed != ""){ ?>  <a class="label label-success margin-left-5 tt" title="<?php $unix = human_to_unix($subscription->subscribed.' 00:00'); echo date($core_settings->date_format, $unix);?>" ><?=$this->lang->line('application_subscribed_via_paypal');?></a> <?php } ?>
			</li>
