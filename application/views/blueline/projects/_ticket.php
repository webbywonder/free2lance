...
<div class="form-group">
        <label for="project_id"><?=$this->lang->line('application_project_id');?></label>

        <input id="project_id" type="text" name="project_id" class="form-control" value="<?=$project->id;?>" required/>
 </div> 
